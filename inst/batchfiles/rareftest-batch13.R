source("betasim_funs.R")
source("Rarefaction_funs.R")
source("beta_miscfuns.R")
source("permutest.betadisper.R")
require(plyr)
require(vegan)
require(reshape2)
fn <- "rareftest-batch13.RData"
descr  <- c(short="raref_power",
            long="POWER 2: pmix*sizediff*popsize*popsizediff; rarefy within permutations, median P (corrected)")
nsim <- 250
